...
| September 7, 2026 | b08 | 197 | 0.1005 | 0.498 / 0.725 | 0.000 / 4.191 | −0.007 / 0.028 | 0.035 / 0.978 | −0.037 / 0.501 | 0.114 / 0.180 | Same generator as b05; five sources in one pool (b05's three + the resting CD4⁺ T-cell screen + vcc2025 H1) with the same control-similarity weights (τ = 0.01) and a 20-cell guard per source and target; H1 covers 25 targets. Best fid and jac so far, pds/reach/nmae between b07 and b05 |
| September 7, 2026 | b09 | 382 | 0.0173 | 0.463 / – | 0.000 / – | −0.023 / – | 0.046 / – | −0.454 / – | 0.072 / – | b05 with one change: only source genes with test |z| > 3 are injected (about 140 per target instead of 7,000). Diagnosis: the scorer then calls only 40–84 genes per target, below the truth's typical set, so fid's coverage term collapses; the discarded |z| 1–3 band also carried most of the real signal (pds, reach and nmae fell; jac unchanged). Selection by evidence is not a lever for this pipeline; raw values not recorded |
