...
| September 7, 2026 | b09 | 382 | 0.0173 | 0.463 / – | 0.000 / – | −0.023 / – | 0.046 / – | −0.454 / – | 0.072 / – | b05 with a single change: source genes enter the injected vector only if their test |z| > 3 instead of > 1 (about 140 genes per target instead of 7,000). Scorer call sets shrank to 40–84 genes per target, below the truth's typical size, and fid's coverage term collapsed; pds and reach also fell. Raw values not recorded |
