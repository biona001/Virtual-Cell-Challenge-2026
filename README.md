...
| September 7, 2026 | b08 | n/a | 0.1005 | 0.498 / – | 0.000 / – | −0.007 / – | 0.035 / – | −0.037 / – | 0.114 / – | Same generator as b05; five sources in one pool (b05's three + the resting CD4⁺ T-cell screen + vcc2025 H1) with the same control-similarity weights (τ = 0.01) and a 20-cell guard per source and target; H1 covers 25 targets. Best fid and jac so far, pds/reach/nmae between b07 and b05; raw values and entry id not recorded |
